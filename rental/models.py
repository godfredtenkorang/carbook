...
class CarForRent(models.Model):
    ...
    car_model = models.CharField(max_length=200, default="", null=True)
    ...
    color = models.CharField(max_length=100, default='Black', null=True)
    image = models.ImageField(upload_to='car_for_rent', null=True)
    accra_price = models.DecimalField(max_digits=10, decimal_places=2)
    outside_price = models.DecimalField(max_digits=10, decimal_places=2)
